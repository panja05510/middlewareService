...
public class ResponseBaseModel implements Serializable {
	...
	public void setCobolfieldsmap(ResponseCBLModel cobolfieldsmap) {
		this.cobolfieldsmap = cobolfieldsmap;
	}
	...
	public void setMfResponseValuesMapping(Map<String, Map<String, String>> mfResponseValuesMapping) {
		this.mfResponseValuesMapping = mfResponseValuesMapping;
	}
